                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4">
                            <div class="single-widget about-widget">
                                <a href="index.html" class="footer-brand-logo mb-25"><img src="assets/images/logohay.jpg" alt="footer-logo"></a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="single-widget">
                                        ...
                                        <ul class="widget-menu show">
                                            <li class="menu-item"><a class="menu-link" href="shop-grid-left-sidebar.html">Category</a></li>
                                            <li class="menu-item"><a class="menu-link" href="shop-grid-right-sidebar.html">Products</a></li>
