                ...
                <div class="customers__table">
                    <div id="ProductSizeTable_wrapper" class="dataTables_wrapper no-footer">    
                        <div class="dataTables_length" id="ProductSizeTable_length">
                            <div class="col-xs-6">
                            <a href="addfabric.php" class="btn btn-md btn-info">Add Fabric</a>
                            </div>
                        </div>
                        ...
                        <table id="ProductTable" class="row-border data-table-filter table-style">
                            ...
                            <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="CategoryTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Category Name: activate to sort column descending" style="width: 30%;">Fabric Name</th>
                                    <th class="sorting_asc" tabindex="0" aria-controls="CategoryTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Category Name: activate to sort column descending" style="width: 30%;">Fabric Image</th>
...
// for click on edit button
        ...
        function fn2(e){
            $.ajax({
                    type: "POST",
                    url: 'ajax.php?action=fabricstatus',
                    data: {
                        pdtid:e
                    },
                    success: function(response)
