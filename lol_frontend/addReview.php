                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-contact-info border-0 text-center">
                                        ...
                                        <p class="contact-info-content">Send us a text & an ambassador will respond 1-814-251-9966</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="single-contact-info text-center">
                                        ...
                                        <p class="contact-info-content">685 Market Street, Erode-638003, India </p>
                                    </div>
                                </div>
                        ...
                        <!-- <div class="contact-form-area">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="EmilAddress" name="EmilAddress" placeholder="Emil Address">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
