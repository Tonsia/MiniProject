                        ...
                        <div class="col-lg-6 col-6">
                            <div class="hero-slider-content text-center">
                                ...
                                <div class="slider-btn">
                                    ...
                                    <a href="http://localhost/lol_frontend/seeall.php?seeall=1" class="secondary-btn">See Collections <i class="iocn flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-6">
                            <div class="hero-slider-content text-center">
                                ...
                                <div class="slider-btn">
                                    <a href="http://localhost/lol_frontend/seeall.php?seeall=2" class="secondary-btn">See Collections <i class="iocn flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5 offset-lg-1 col-6">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-6">
                            <div class="hero-slider-content text-center">
                                ...
                                <div class="slider-btn">
                                    <a href="http://localhost/lol_frontend/seeall.php?seeall=3" class="secondary-btn">See Collections <i class="iocn flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5 offset-lg-1 col-6">
