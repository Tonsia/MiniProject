...
<html lang="en">
    ...
    <head>
        ...
        <title>Single Product-2 - Zairito - eCommerce HTML Template</title>
            ...
            <div class="header-middle">
                <div class="header-wrap">
                    ...
                    <div class="brand-logo-area">
                        <a href="index2.html" class="brand-logo"><img class="brand-image" src="assets/images/zairito-home-two.png" alt="zairito-home-two"></a>
                    </div>
                    <div class="header-right">
                        <ul class="btn-list">
                            ...
                            <li class="single-item compare-area"><a class="single-btn compare-btn" href="compare.html"><i class="btn-icon flaticon-bar-chart"></i></a></li>
            ...
            <div class="header-bottom">
                <nav class="menu-area">
                    <ul class="main-menu">
                        ...
                        <li class="menu-item menu-item-has-children">
                            <a class="menu-link" href="index2.html">Pages <i class="arrow-icon fas fa-angle-down"></i></a>
                            <ul class="sub-menu">
            ...
            <div class="container">
                <div class="menu-wrap">
                    <div class="header-left">
                        <a class="brand-logo" href="index.html"><img class="brand-image" src="assets/images/zairito-home-two.png" alt="zairito"></a>
                    </div>
                    <div class="header-right">
                        <ul class="btn-list">
                            <li class="single-item wishlist-area"><a class="single-btn wishlist-btn" href="wish-list.html"><i class="btn-icon flaticon-like"></i></a></li>
            ...
            <div class="container">
                <div class="breadcrumb-wrap text-center">
                    <ul class="breadcrumb-pages">
                        ...
                        <li class="page-item"><a class="page-item-link" href="shop-grid.html">Products</a></li>
                            ...
                            <div class="product-single-left">
                                <div class="product-slier-big-image">
                                    <div class="product-priview-slide-v2">
                                        <div class="single-slide">
                                            <img class="slide-image" src="assets/images/home-two-product-image-2.png" alt="product">
                                        </div>
                                        <div class="single-slide">
                                            <img class="slide-image" src="assets/images/home-two-product-image-3.png" alt="product">
                                        </div>
                                        <div class="single-slide">
                                            <img class="slide-image" src="assets/images/home-two-product-image-1.png" alt="product">
                                        </div>
                                        <div class="single-slide">
                                            <img class="slide-image" src="assets/images/home-two-product-image-3.png" alt="product">
                                        </div>
                                ...
                                <div class="product-thumbnail-image">
                                    <ul class="product-thumb-silide-v2">
                                        <li class="single-item"><img class="single-item-image" src="assets/images/home-two-product-image-2.png" alt="product"></li>
                                        <li class="single-item"><img class="single-item-image" src="assets/images/home-two-product-image-3.png" alt="product"></li>
                                        <li class="single-item"><img class="single-item-image" src="assets/images/home-two-product-image-1.png" alt="product"></li>
                                        <li class="single-item"><img class="single-item-image" src="assets/images/home-two-product-image-3.png" alt="product"></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="single-review">
                                        <div class="reviewer">
                                            <div class="reviewer-wrap">
                                                ...
                                                <div class="reviewer-info">
                                                    <h4 class="reviewer-name">James Williamson</h4>
                                                    <h4 class="review-meta"><span class="time">25th Sep 2021 </span> by <a class="author" href="javascript:void(0)">John Doe</a></h4>
                                                </div>
                                            </div>
                                            <ul class="review-list">
                                                <li class="review-item active"><i class="flaticon-star"></i></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-grid-product-v2">
                            <div class="product-top">
                                <a href="single-product-v2.html"><img class="product-thumbnal" src="assets/images/home-two-product-image-1.png" alt="product"></a>
                            ...
                            <div class="product-info text-center">
                                <h4 class="product-catagory">ELLA - HALOTHEMES</h4>
                                <h3 class="product-name"><a class="product-link" href="single-product-v2.html">Rosmo Namino Milancelos</a></h3>
                                <ul class="product-review">
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-grid-product-v2">
                            <div class="product-top">
                                <a href="single-product-v2.html"><img class="product-thumbnal" src="assets/images/home-two-product-image-2.png" alt="product"></a>
                                <div class="product-flags">
                                    <span class="product-flag sale">SALE</span>
                                    <span class="product-flag discount">-15%</span>
                                </div>
                            ...
                            <div class="product-info text-center">
                                <h4 class="product-catagory">Product - Collection</h4>
                                <h3 class="product-name"><a class="product-link" href="single-product-v2.html">Midi Dress</a></h3>
                                <ul class="product-review">
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-grid-product-v2">
                            <div class="product-top">
                                <a href="single-product-v2.html"><img class="product-thumbnal" src="assets/images/home-two-product-image-3.png" alt="product"></a>
                                <div class="product-flags">
                                    <span class="product-flag sale">SALE</span>
                                    <span class="product-flag discount">-15%</span>
                                </div>
                            ...
                            <div class="product-info text-center">
                                ...
                                <h3 class="product-name"><a class="product-link" href="single-product-v2.html">Fit-Flare Dress</a></h3>
                                <ul class="product-review">
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                                    <li class="review-item active"><i class="flaticon-star"></i></li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="single-widget about-widget">
                                <a href="index.html" class="footer-brand-logo mb-25"><img src="assets/images/footer-logo-two.png" alt="footer-logo"></a>
