                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-vertical__item bg-style">
                                        <form enctype="multipart/form-data" method="POST" action="{{route('admin.store_role')}}">
                                            @csrf
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input__group mb-25">
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" value="{{$value->id}}" name="permission[]" class="custom-control-input" id="customSwitch{{$value->id}}">
