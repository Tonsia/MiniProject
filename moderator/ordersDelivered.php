                        ...
                        <?php
                                    ...
                                    if ($qry0->num_rows > 0) 
                                    {
                                        ...
                                        while($row0 = $qry0->fetch_assoc()) 
                                        {
                                            $cartid = $row0["cartid"];
                                            $userid = $row0["userid"];
                                            $qry1 = $conn->query("SELECT * FROM cart WHERE id = '$cartid' AND status='5'");$row1 = $qry1->fetch_assoc();
                                            ...
                                            // $qry7=$conn->query("SELECT * FROM orders where reg_id ='$userid'"); $row7=$qry7->fetch_array();
                                            }
                                            $statusstr = '';
                                            if($status==2){
                                                $statusstr = "Pending";
